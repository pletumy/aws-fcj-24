...
if ("TURBOPACK compile-time falsy", 0) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        if ("TURBOPACK compile-time truthy", 1) {
            module.exports = __turbopack_require__("[externals]/ [external] (next/dist/compiled/next-server/app-page-experimental.runtime.dev.js, cjs)");
        } else {
            "TURBOPACK unreachable";
        }
    } else {
...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function ResponseInstance(bundlerConfig, moduleLoading, callServer, encodeFormAction, nonce, temporaryReferences, findSourceMapURL, replayConsole, environmentName) {
        ...
        supportsCreateTask && (this._debugRootTask = console.createTask('"use ' + bundlerConfig.toLowerCase() + '"'));
    ...
    function processFullBinaryRow(response, id, tag, buffer, chunk) {
        ...
        switch(tag){
            ...
            case 69:
                ...
                as = errorInfo.env;
                errorInfo = buildFakeCallStack(response, errorInfo.stack, as, Error.bind(null, errorInfo.message || "An error occurred in the Server Components render but no message was provided"));
                ...
                (as = model.get(id)) ? triggerErrorOnChunk(as, errorInfo) : model.set(id, new Chunk("rejected", null, errorInfo, response));
                break;
            case 84:
                model = response._chunks;
            ...
            case 68:
                ...
                initializeFakeTask(response, model, void 0 === model.env ? response._rootEnvironmentName : model.env);
                    ...
                    try {
                        b: {
                            ...
                            switch(id){
                                ...
                                case "groupEnd":
                                case "table":
                                    model = bind$1.apply(console[id], [
                                        console
                                    ].concat(stringDecoder));
                                    break b;
                                case "assert":
                                    i = 1;
                            }
                            as = stringDecoder.slice(0);
                            "string" === typeof as[i] ? as.splice(i, 1, "\u001b[0m\u001b[7m%c%s\u001b[0m%c " + as[i], "background: #e6e6e6;background: light-dark(rgba(0,0,0,0.1), rgba(255,255,255,0.25));color: #000000;color: light-dark(#000000, #ffffff);border-radius: 2px", " " + chunk + " ", "") : as.splice(i, 0, "\u001b[0m\u001b[7m%c%s\u001b[0m%c ", "background: #e6e6e6;background: light-dark(rgba(0,0,0,0.1), rgba(255,255,255,0.25));color: #000000;color: light-dark(#000000, #ffffff);border-radius: 2px", " " + chunk + " ", "");
                            as.unshift(console);
                            model = bind$1.apply(console[id], as);
                        }
                        errorInfo = buildFakeCallStack(response, buffer, chunk, model);
                        if (null != tag && (rootTask = initializeFakeTask(response, tag, chunk), initializeFakeStack(response, tag), null !== rootTask)) {
                            rootTask.run(errorInfo);
                            break a;
                        }
                        var rootTask$jscomp$0 = getRootTask(response, chunk);
                        null != rootTask$jscomp$0 ? rootTask$jscomp$0.run(errorInfo) : errorInfo();
                    } finally{
            ...
            case 80:
                ...
                model = buildFakeCallStack(response, model.stack, model.env, Error.bind(null, model.reason || ""));
                as = response._debugRootTask;
                model = null != as ? as.run(model) : model();
                model.$$typeof = REACT_POSTPONE_TYPE;
                as = response._chunks;
                (errorInfo = as.get(id)) ? triggerErrorOnChunk(errorInfo, model) : as.set(id, new Chunk("rejected", null, model, response));
                break;
            default:
        ...
        return function(key, value) {
            ...
            if ("object" === typeof value && null !== value) {
                if (value[0] === REACT_ELEMENT_TYPE) {
                    ...
                    null !== stack && (normalizedStackTrace = createFakeJSXCallStackInDEV(response, stack, validated));
                    ...
                    null !== initializingHandler ? (stack = initializingHandler, initializingHandler = stack.parent, stack.errored ? (key = new Chunk("rejected", null, stack.value, response), stack = {
                        name: getComponentNameFromType(value.type) || "",
                        owner: value._owner
                    }, stack.debugStack = value._debugStack, stack.debugTask = value._debugTask, key._debugInfo = [
                        stack
                    ], value = createLazyChunkWrapper(key)) : 0 < stack.deps && (key = new Chunk("blocked", null, null, response), stack.value = value, stack.chunk = key, value = Object.freeze.bind(Object, value.props), key.then(value, value), value = createLazyChunkWrapper(key))) : Object.freeze(value.props);
                }
                return value;
            }
            return value;
    ...
    }, createFakeJSXCallStackInDEV = createFakeJSXCallStack["react-stack-bottom-frame"].bind(createFakeJSXCallStack), currentOwnerInDEV = null;
        ...
        "children": [
            "guestbook",
            {
                "children": [
                    ...
                    {
                        "page": [
                            ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$guestbook$2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29$__,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$app$2d$page$2e$js$3f$page$3d2f$guestbook$2f$page__$7b$__COMPONENT_0__$3d3e$__$225b$project$5d2f$app$2f$layout$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__COMPONENT_1__$3d3e$__$225b$project$5d2f$app$2f$error$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__COMPONENT_2__$3d3e$__$225b$project$5d2f$app$2f$not$2d$found$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__COMPONENT_3__$3d3e$__$225b$project$5d2f$app$2f$guestbook$2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__METADATA_4__$3d3e$__$225b$project$5d2f$app$2f$favicon$2e$ico$2e$mjs__$7b$__IMAGE__$3d3e$__$5c225b$project$5d2f$app$2f$favicon$2e$ico__$5b$app$2d$rsc$5d$__$28$static$295c22$__$7d$__$5b$app$2d$rsc$5d$__$28$structured__image__object$2c$__ecmascript$29222c$__METADATA_5__$3d3e$__$225b$project$5d2f$app$2f$opengraph$2d$image$2e$jpg$2e$mjs__$7b$__IMAGE__$3d3e$__$5c225b$project$5d2f$app$2f$opengraph$2d$image$2e$jpg__$5b$app$2d$rsc$5d$__$28$static$295c22$__$7d$__$5b$app$2d$rsc$5d$__$28$structured__image__object$2c$__ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_import__('[project]/node_modules/next/dist/esm/build/templates/app-page.js?page=/guestbook/page { COMPONENT_0 => "[project]/app/layout.tsx [app-rsc] (ecmascript, Next.js server component)", COMPONENT_1 => "[project]/app/error.tsx [app-rsc] (ecmascript, Next.js server component)", COMPONENT_2 => "[project]/app/not-found.tsx [app-rsc] (ecmascript, Next.js server component)", COMPONENT_3 => "[project]/app/guestbook/page.tsx [app-rsc] (ecmascript, Next.js server component)", METADATA_4 => "[project]/app/favicon.ico.mjs { IMAGE => \\"[project]/app/favicon.ico [app-rsc] (static)\\" } [app-rsc] (structured image object, ecmascript)", METADATA_5 => "[project]/app/opengraph-image.jpg.mjs { IMAGE => \\"[project]/app/opengraph-image.jpg [app-rsc] (static)\\" } [app-rsc] (structured image object, ecmascript)" } [app-rsc] (ecmascript) <locals>');
"__TURBOPACK__ecmascript__hoisting__location__";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$app$2d$page$2e$js$3f$page$3d2f$guestbook$2f$page__$7b$__COMPONENT_0__$3d3e$__$225b$project$5d2f$app$2f$layout$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__COMPONENT_1__$3d3e$__$225b$project$5d2f$app$2f$error$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__COMPONENT_2__$3d3e$__$225b$project$5d2f$app$2f$not$2d$found$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__COMPONENT_3__$3d3e$__$225b$project$5d2f$app$2f$guestbook$2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__METADATA_4__$3d3e$__$225b$project$5d2f$app$2f$favicon$2e$ico$2e$mjs__$7b$__IMAGE__$3d3e$__$5c225b$project$5d2f$app$2f$favicon$2e$ico__$5b$app$2d$rsc$5d$__$28$static$295c22$__$7d$__$5b$app$2d$rsc$5d$__$28$structured__image__object$2c$__ecmascript$29222c$__METADATA_5__$3d3e$__$225b$project$5d2f$app$2f$opengraph$2d$image$2e$jpg$2e$mjs__$7b$__IMAGE__$3d3e$__$5c225b$project$5d2f$app$2f$opengraph$2d$image$2e$jpg__$5b$app$2d$rsc$5d$__$28$static$295c22$__$7d$__$5b$app$2d$rsc$5d$__$28$structured__image__object$2c$__ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_import__('[project]/node_modules/next/dist/esm/build/templates/app-page.js?page=/guestbook/page { COMPONENT_0 => "[project]/app/layout.tsx [app-rsc] (ecmascript, Next.js server component)", COMPONENT_1 => "[project]/app/error.tsx [app-rsc] (ecmascript, Next.js server component)", COMPONENT_2 => "[project]/app/not-found.tsx [app-rsc] (ecmascript, Next.js server component)", COMPONENT_3 => "[project]/app/guestbook/page.tsx [app-rsc] (ecmascript, Next.js server component)", METADATA_4 => "[project]/app/favicon.ico.mjs { IMAGE => \\"[project]/app/favicon.ico [app-rsc] (static)\\" } [app-rsc] (structured image object, ecmascript)", METADATA_5 => "[project]/app/opengraph-image.jpg.mjs { IMAGE => \\"[project]/app/opengraph-image.jpg [app-rsc] (static)\\" } [app-rsc] (structured image object, ecmascript)" } [app-rsc] (ecmascript) <module evaluation>');
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$app$2d$page$2e$js$3f$page$3d2f$guestbook$2f$page__$7b$__COMPONENT_0__$3d3e$__$225b$project$5d2f$app$2f$layout$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__COMPONENT_1__$3d3e$__$225b$project$5d2f$app$2f$error$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__COMPONENT_2__$3d3e$__$225b$project$5d2f$app$2f$not$2d$found$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__COMPONENT_3__$3d3e$__$225b$project$5d2f$app$2f$guestbook$2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__component$29222c$__METADATA_4__$3d3e$__$225b$project$5d2f$app$2f$favicon$2e$ico$2e$mjs__$7b$__IMAGE__$3d3e$__$5c225b$project$5d2f$app$2f$favicon$2e$ico__$5b$app$2d$rsc$5d$__$28$static$295c22$__$7d$__$5b$app$2d$rsc$5d$__$28$structured__image__object$2c$__ecmascript$29222c$__METADATA_5__$3d3e$__$225b$project$5d2f$app$2f$opengraph$2d$image$2e$jpg$2e$mjs__$7b$__IMAGE__$3d3e$__$5c225b$project$5d2f$app$2f$opengraph$2d$image$2e$jpg__$5b$app$2d$rsc$5d$__$28$static$295c22$__$7d$__$5b$app$2d$rsc$5d$__$28$structured__image__object$2c$__ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_import__('[project]/node_modules/next/dist/esm/build/templates/app-page.js?page=/guestbook/page { COMPONENT_0 => "[project]/app/layout.tsx [app-rsc] (ecmascript, Next.js server component)", COMPONENT_1 => "[project]/app/error.tsx [app-rsc] (ecmascript, Next.js server component)", COMPONENT_2 => "[project]/app/not-found.tsx [app-rsc] (ecmascript, Next.js server component)", COMPONENT_3 => "[project]/app/guestbook/page.tsx [app-rsc] (ecmascript, Next.js server component)", METADATA_4 => "[project]/app/favicon.ico.mjs { IMAGE => \\"[project]/app/favicon.ico [app-rsc] (static)\\" } [app-rsc] (structured image object, ecmascript)", METADATA_5 => "[project]/app/opengraph-image.jpg.mjs { IMAGE => \\"[project]/app/opengraph-image.jpg [app-rsc] (static)\\" } [app-rsc] (structured image object, ecmascript)" } [app-rsc] (ecmascript) <exports>');
"__TURBOPACK__ecmascript__hoisting__location__";
...
//# sourceMappingURL=node_modules_next_3b4602._.js.map