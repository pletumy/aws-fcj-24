...
/** Server-side method to read the session. */ async function getSession(headers, config) {
    const origin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$lib$2f$env$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["detectOrigin"])(headers);
...
async function handleAuth(args, config, userMiddlewareOrRoute) {
    ...
    if (authorized instanceof Response) {
        ...
        if (request.nextUrl.pathname !== signInPage) {
            ...
            response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["NextResponse"].redirect(request.nextUrl);
        }
    }
...
async function signIn(provider, options, authorizationParams, config) {
    ...
    const base = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$lib$2f$env$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["detectOrigin"])(headers)}/signin`;
    if (!provider) {
...
async function signOut(options, config) {
    const headers = new Headers((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["headers"])());
    headers.set("Content-Type", "application/x-www-form-urlencoded");
    const url = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$lib$2f$env$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["detectOrigin"])(headers)}/signout`;
...
async function update(data, config) {
    ...
    const url = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$lib$2f$env$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["detectOrigin"])(headers)}session`;
...
"[project]/node_modules/next-auth/index.js [app-rsc] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
const fs_1 = __turbopack_require__("[externals]/ [external] (fs, cjs)");
const os_1 = __turbopack_require__("[externals]/ [external] (os, cjs)");
/**
...
const https_1 = __turbopack_require__("[externals]/ [external] (https, cjs)");
...
const querystring_1 = __importDefault(__turbopack_require__("[externals]/ [external] (querystring, cjs)"));
...
/* eslint-disable @typescript-eslint/no-explicit-any */ const fetch = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : node_fetch_1.default;
function hasWindow() {
...
const http = __importStar(__turbopack_require__("[externals]/ [external] (http, cjs)"));
const https = __importStar(__turbopack_require__("[externals]/ [external] (https, cjs)"));
...
const net = __importStar(__turbopack_require__("[externals]/ [external] (net, cjs)"));
const tls = __importStar(__turbopack_require__("[externals]/ [external] (tls, cjs)"));
const assert_1 = __importDefault(__turbopack_require__("[externals]/ [external] (assert, cjs)"));
const debug_1 = __importDefault(__turbopack_require__("[project]/node_modules/debug/src/index.js [app-rsc] (ecmascript)"));
...
const fs = __turbopack_require__("[externals]/ [external] (fs, cjs)");
const google_auth_library_1 = __turbopack_require__("[project]/node_modules/google-auth-library/build/src/index.js [app-rsc] (ecmascript)");
const resolve = __turbopack_require__("[externals]/ [external] (url, cjs)");
const util = __turbopack_require__("[externals]/ [external] (util, cjs)");
const apirequest_1 = __turbopack_require__("[project]/node_modules/googleapis-common/build/src/apirequest.js [app-rsc] (ecmascript)");
...
//# sourceMappingURL=node_modules_94fd52._.js.map