...
function assertConfig(request, options) {
    ...
    const { callbackUrl: defaultCallbackUrl } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$cookie$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["defaultCookies"])(options.useSecureCookies ?? url.protocol === "https:");
...
async function decode(params) {
    ...
    const encryptionSecret = await getDerivedEncryptionKey(secret);
    const { payload } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jwt$2f$decrypt$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jwtDecrypt"])(token, encryptionSecret, {
        clockTolerance: 15
    });
    return payload;
}
...
async function getDerivedEncryptionKey(secret) {
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$panva$2f$hkdf$2f$dist$2f$node$2f$esm$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["hkdf"])("sha256", secret, "", "Auth.js Generated Encryption Key", 32);
}
...
async function createCSRFToken({ options, cookieValue, isPost, bodyValue }) {
    if (cookieValue) {
        ...
        const expectedCsrfTokenHash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$web$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createHash"])(`${csrfToken}${options.secret}`);
    ...
    // New CSRF token
    const csrfToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$web$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["randomString"])(32);
    const csrfTokenHash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$web$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createHash"])(`${csrfToken}${options.secret}`);
...
async function init({ authOptions, providerId, action, url: reqUrl, cookies: reqCookies, callbackUrl: reqCallbackUrl, csrfToken: reqCsrfToken, csrfDisabled, isPost }) {
    ...
    const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$utils$2f$parse$2d$url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])(reqUrl.origin + reqUrl.pathname.replace(`/${action}`, "").replace(`/${providerId}`, ""));
    const url = new URL(parsed.toString());
    const { providers, provider } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$providers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({
    ...
    const cookies = [];
    if (!csrfDisabled) {
        const { csrfToken, cookie: csrfCookie, csrfTokenVerified } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$csrf$2d$token$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createCSRFToken"])({
            options,
    ...
    const { callbackUrl, callbackUrlCookie } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$callback$2d$url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createCallbackUrl"])({
        options,
...
function ErrorPage(props) {
    ...
    const errors = {
        ...
        verification: {
            ...
            signin: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsx"])("p", {
                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsx"])("a", {
                    className: "button",
                    href: signinPageUrl,
                    children: "Sign in"
      ...
      `
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsxs"])("div", {
                ...
                children: [
                    ...
                    providers.map((provider, i)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsxs"])("div", {
                            className: "provider",
                            children: [
                                provider.type === "oauth" || provider.type === "oidc" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsxs"])("form", {
                                    ...
                                    children: [
                                        ...
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsxs"])("button", {
                                            ...
                                            children: [
                                                provider.style?.logo && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsx"])("img", {
                                                    loading: "lazy",
                                                    height: 24,
                                                    width: 24,
                                                    id: "provider-logo",
                                                ...
                                                provider.style?.logoDark && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsx"])("img", {
                                                    loading: "lazy",
                                                    height: 24,
                                                    width: 24,
                                ...
                                (provider.type === "email" || provider.type === "credentials") && i > 0 && providers[i - 1].type !== "email" && providers[i - 1].type !== "credentials" && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsx"])("hr", {}),
                                ...
                                (provider.type === "email" || provider.type === "credentials") && i + 1 < providers.length && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2f$jsx$2d$runtime$2f$dist$2f$jsxRuntime$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsx"])("hr", {})
                            ]
                        }, provider.id))
                ]
            })
...
function send({ html, title, status, cookies, theme }) {
    return {
        ...
        body: `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1.0"><style>${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$pages$2f$styles$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]}</style><title>${title}</title></head><body class="__next-auth-theme-${theme?.colorScheme ?? "auto"}"><div class="page">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$preact$2d$render$2d$to$2d$string$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["renderToString"])(html)}</div></body></html>`
    };
}
...
function handleState(query, provider, isOnRedirectProxy) {
    ...
    const state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$oauth$2f$checks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decodeState"])(query?.state);
...
async function callback(params) {
    ...
    try {
        if (provider.type === "oauth" || provider.type === "oidc") {
            const { proxyRedirect, randomState } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$oauth$2f$handle$2d$state$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleState"])(query, provider, options.isOnRedirectProxy);
            if (proxyRedirect) {
            ...
            const authorizationResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$oauth$2f$callback$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleOAuth"])(query, params.cookies, options, randomState);
            ...
            const unauthorizedOrError = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$shared$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleAuthorized"])({
            ...
            // Sign user in
            const { user, session, isNewUser } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$callback$2d$handler$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleLogin"])(sessionStore.value, userFromProvider, account, options);
            if (useJwtSession) {
                const defaultToken = {
                    name: user.name,
                    email: user.email,
            ...
            const invite = await adapter.useVerificationToken({
                identifier,
                token: await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$web$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createHash"])(`${token}${secret}`)
            });
            ...
            // Sign user in
            const { user: loggedInUser, session, isNewUser } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$callback$2d$handler$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleLogin"])(sessionStore.value, user, account, options);
            if (useJwtSession) {
                const defaultToken = {
...
async function email(identifier, options, request) {
    ...
    const token = await provider.generateVerificationToken?.() ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$web$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["randomString"])(32);
    ...
    await Promise.all([
        provider.sendVerificationRequest({
            ...
            provider,
            theme,
            request: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$web$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toRequest"])(request)
        }),
        // @ts-expect-error -- Verified in `assertConfig`.
...
async function signin(request, options) {
    ...
    try {
        if (provider.type === "oauth" || provider.type === "oidc") {
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$oauth$2f$authorization$2d$url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAuthorizationUrl"])(query, options);
        } else if (provider.type === "email") {
            ...
            const redirect = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$email$2f$signin$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])(email, options, request);
            return {
                redirect
            };
        }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_import__("[project]/node_modules/@auth/core/lib/routes/index.js [app-rsc] (ecmascript) <locals>");
"__TURBOPACK__ecmascript__hoisting__location__";
...
__turbopack_esm__({
    "callback": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__["callback"],
    "providers": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__["providers"],
    "session": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__["session"],
    "signin": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__["signin"],
    "signout": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__["signout"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_import__("[project]/node_modules/@auth/core/lib/routes/index.js [app-rsc] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_import__("[project]/node_modules/@auth/core/lib/routes/index.js [app-rsc] (ecmascript) <exports>");
"__TURBOPACK__ecmascript__hoisting__location__";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_import__("[project]/node_modules/@auth/core/lib/routes/index.js [app-rsc] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$facade$3e$__ = __turbopack_import__("[project]/node_modules/@auth/core/lib/routes/index.js [app-rsc] (ecmascript) <facade>");
"__TURBOPACK__ecmascript__hoisting__location__";
;
;
;
...
async function AuthInternal(request, authOptions) {
    ...
    if (method === "GET") {
        ...
        switch(action){
            case "providers":
                return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$facade$3e$__.providers(options.providers);
            case "session":
                {
                    const session = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$facade$3e$__.session({
                        sessionStore,
                        options
                    });
            ...
            case "callback":
                if (options.provider) {
                    const callback = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$facade$3e$__.callback({
                        body: request.body,
                        query: request.query,
                        headers: request.headers,
                        cookies: request.cookies,
        ...
        switch(action){
            case "signin":
                if ((csrfDisabled || options.csrfTokenVerified) && options.provider) {
                    const signin = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$facade$3e$__.signin(request, options);
            ...
            case "signout":
                if (csrfDisabled || options.csrfTokenVerified) {
                    const signout = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$routes$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$facade$3e$__.signout(sessionStore, options);
...
async function Auth(request, config) {
    ...
    const internalRequest = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$web$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toInternalRequest"])(request);
    ...
    const assertionResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$assert$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["assertConfig"])(internalRequest, config);
    if (Array.isArray(assertionResult)) {
        ...
        if (!pages?.error || authOnErrorPage) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$web$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toResponse"])(page);
        }
    ...
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$lib$2f$web$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["toResponse"])(internalResponse);
...
//# sourceMappingURL=node_modules_%40auth_core_3715d2._.js.map