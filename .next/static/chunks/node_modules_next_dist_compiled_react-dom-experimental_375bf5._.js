...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function useEffectEventImpl(payload) {
        ...
        if (null === componentUpdateQueue) componentUpdateQueue = createFunctionComponentUpdateQueue(), currentlyRenderingFiber$1.updateQueue = componentUpdateQueue, componentUpdateQueue.events = [
            payload
        ];
        else {
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        (JSCompiler_object_inline_componentStack_2300 = didSuspend) || (JSCompiler_object_inline_componentStack_2300 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_componentStack_2300 && (JSCompiler_object_inline_message_2297 = !0, workInProgress.flags &= -129);
        JSCompiler_object_inline_componentStack_2300 = 0 !== (workInProgress.flags & 32);
        workInProgress.flags &= -33;
        if (null === current) {
            if (isHydrating) {
                JSCompiler_object_inline_message_2297 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
                if (isHydrating) {
                    ...
                    JSCompiler_temp && (warnNonHydratedInstance(workInProgress, JSCompiler_object_inline_digest_2298), throwOnHydrationMismatch(workInProgress));
                }
                JSCompiler_object_inline_digest_2298 = workInProgress.memoizedState;
                if (null !== JSCompiler_object_inline_digest_2298 && (JSCompiler_object_inline_digest_2298 = JSCompiler_object_inline_digest_2298.dehydrated, null !== JSCompiler_object_inline_digest_2298)) return JSCompiler_object_inline_digest_2298.data === SUSPENSE_FALLBACK_START_DATA ? workInProgress.lanes = 16 : workInProgress.lanes = 536870912, null;
                popSuspenseHandler(workInProgress);
            }
            JSCompiler_object_inline_digest_2298 = JSCompiler_object_inline_stack_2299.children;
            JSCompiler_temp = JSCompiler_object_inline_stack_2299.fallback;
            if (JSCompiler_object_inline_message_2297) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2299 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2298, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2297 = workInProgress.child, JSCompiler_object_inline_message_2297.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2297.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2300, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2299;
            if ("number" === typeof JSCompiler_object_inline_stack_2299.unstable_expectedLoadTime) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2299 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2298, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2297 = workInProgress.child, JSCompiler_object_inline_message_2297.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2297.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2300, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress.lanes = 4194304, JSCompiler_object_inline_stack_2299;
            pushPrimaryTreeSuspenseHandler(workInProgress);
            return mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_digest_2298);
        }
        var prevState = current.memoizedState;
        if (null !== prevState && (JSCompiler_object_inline_digest_2298 = prevState.dehydrated, null !== JSCompiler_object_inline_digest_2298)) {
            if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2297 = JSCompiler_object_inline_stack_2299.fallback, JSCompiler_object_inline_digest_2298 = workInProgress.mode, JSCompiler_object_inline_stack_2299 = mountWorkInProgressOffscreenFiber({
                mode: "visible",
                children: JSCompiler_object_inline_stack_2299.children
            }, JSCompiler_object_inline_digest_2298), JSCompiler_object_inline_message_2297 = createFiberFromFragment(JSCompiler_object_inline_message_2297, JSCompiler_object_inline_digest_2298, renderLanes, null), JSCompiler_object_inline_message_2297.flags |= 2, JSCompiler_object_inline_stack_2299.return = workInProgress, JSCompiler_object_inline_message_2297.return = workInProgress, JSCompiler_object_inline_stack_2299.sibling = JSCompiler_object_inline_message_2297, workInProgress.child = JSCompiler_object_inline_stack_2299, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2299 = workInProgress.child, JSCompiler_object_inline_stack_2299.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2299.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2300, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = JSCompiler_object_inline_message_2297);
            else if (pushPrimaryTreeSuspenseHandler(workInProgress), isHydrating && console.error("We should not be hydrating here. This is a bug in React. Please file a bug."), JSCompiler_object_inline_digest_2298.data === SUSPENSE_FALLBACK_START_DATA) {
                JSCompiler_object_inline_componentStack_2300 = JSCompiler_object_inline_digest_2298.nextSibling && JSCompiler_object_inline_digest_2298.nextSibling.dataset;
                if (JSCompiler_object_inline_componentStack_2300) {
                    ...
                    var componentStack = JSCompiler_object_inline_componentStack_2300.cstck;
                }
                ...
                "POSTPONE" !== JSCompiler_object_inline_digest_2298 && (JSCompiler_object_inline_message_2297 = JSCompiler_object_inline_message_2297 ? Error(JSCompiler_object_inline_message_2297) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."), JSCompiler_object_inline_message_2297.stack = JSCompiler_object_inline_stack_2299 || "", JSCompiler_object_inline_message_2297.digest = JSCompiler_object_inline_digest_2298, JSCompiler_object_inline_componentStack_2300 = void 0 === JSCompiler_object_inline_componentStack_2300 ? null : JSCompiler_object_inline_componentStack_2300, "string" === typeof JSCompiler_object_inline_componentStack_2300 && CapturedStacks.set(JSCompiler_object_inline_message_2297, JSCompiler_object_inline_componentStack_2300), queueHydrationError({
                    value: JSCompiler_object_inline_message_2297,
                    source: null,
                    stack: JSCompiler_object_inline_componentStack_2300
                }));
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else if (didReceiveUpdate || propagateParentContextChanges(current, workInProgress, renderLanes, !1), JSCompiler_object_inline_componentStack_2300 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_componentStack_2300) {
                ...
                if (null !== JSCompiler_object_inline_componentStack_2300) {
                    ...
                    if (0 !== (JSCompiler_object_inline_stack_2299 & 42)) JSCompiler_object_inline_stack_2299 = 1;
                    else switch(JSCompiler_object_inline_stack_2299){
                        case 2:
                    ...
                    JSCompiler_object_inline_stack_2299 = 0 !== (JSCompiler_object_inline_stack_2299 & (JSCompiler_object_inline_componentStack_2300.suspendedLanes | renderLanes)) ? 0 : JSCompiler_object_inline_stack_2299;
                    if (0 !== JSCompiler_object_inline_stack_2299 && JSCompiler_object_inline_stack_2299 !== prevState.retryLane) throw prevState.retryLane = JSCompiler_object_inline_stack_2299, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2299), scheduleUpdateOnFiber(JSCompiler_object_inline_componentStack_2300, current, JSCompiler_object_inline_stack_2299), SelectiveHydrationException;
                }
                JSCompiler_object_inline_digest_2298.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else JSCompiler_object_inline_digest_2298.data === SUSPENSE_PENDING_START_DATA ? (workInProgress.flags |= 128, workInProgress.child = current.child, workInProgress = retryDehydratedSuspenseBoundary.bind(null, current), JSCompiler_object_inline_digest_2298._reactRetry = workInProgress, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_digest_2298.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current.id, treeContextOverflow = current.overflow, treeContextProvider = workInProgress), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2299.children), workInProgress.flags |= 4096);
            return workInProgress;
        }
        if (JSCompiler_object_inline_message_2297) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2297 = JSCompiler_object_inline_stack_2299.fallback, JSCompiler_object_inline_digest_2298 = workInProgress.mode, JSCompiler_temp = current.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2299 = createWorkInProgress(JSCompiler_temp, {
            mode: "hidden",
            children: JSCompiler_object_inline_stack_2299.children
        }), JSCompiler_object_inline_stack_2299.subtreeFlags = JSCompiler_temp.subtreeFlags & 31457280, null !== instance ? JSCompiler_object_inline_message_2297 = createWorkInProgress(instance, JSCompiler_object_inline_message_2297) : (JSCompiler_object_inline_message_2297 = createFiberFromFragment(JSCompiler_object_inline_message_2297, JSCompiler_object_inline_digest_2298, renderLanes, null), JSCompiler_object_inline_message_2297.flags |= 2), JSCompiler_object_inline_message_2297.return = workInProgress, JSCompiler_object_inline_stack_2299.return = workInProgress, JSCompiler_object_inline_stack_2299.sibling = JSCompiler_object_inline_message_2297, workInProgress.child = JSCompiler_object_inline_stack_2299, JSCompiler_object_inline_stack_2299 = JSCompiler_object_inline_message_2297, JSCompiler_object_inline_message_2297 = workInProgress.child, JSCompiler_object_inline_digest_2298 = current.child.memoizedState, null === JSCompiler_object_inline_digest_2298 ? JSCompiler_object_inline_digest_2298 = mountSuspenseOffscreenState(renderLanes) : (JSCompiler_temp = JSCompiler_object_inline_digest_2298.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? {
            parent: instance,
            pool: instance
        } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_digest_2298 = {
            baseLanes: JSCompiler_object_inline_digest_2298.baseLanes | renderLanes,
            cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_message_2297.memoizedState = JSCompiler_object_inline_digest_2298, JSCompiler_object_inline_message_2297.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2300, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2299;
        pushPrimaryTreeSuspenseHandler(workInProgress);
        ...
        null !== current && (JSCompiler_object_inline_componentStack_2300 = workInProgress.deletions, null === JSCompiler_object_inline_componentStack_2300 ? (workInProgress.deletions = [
            current
        ], workInProgress.flags |= 16) : JSCompiler_object_inline_componentStack_2300.push(current));
    ...
    function commitBeforeMutationEffectsOnFiber(finishedWork) {
        ...
        switch(finishedWork.tag){
            case 0:
                if (0 !== (flags & 4) && (finishedWork = finishedWork.updateQueue, finishedWork = null !== finishedWork ? finishedWork.events : null, null !== finishedWork)) for(current = 0; current < finishedWork.length; current++)flags = finishedWork[current], flags.ref.impl = flags.nextImpl;
                break;
            case 11:
            case 15:
                break;
    ...
    (function() {
        ...
        if ("19.0.0-experimental-187dd6a7-20240806" !== isomorphicReactPackageVersion) throw Error('Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' + (isomorphicReactPackageVersion + "\n  - react-dom:  19.0.0-experimental-187dd6a7-20240806\nLearn more: https://react.dev/warnings/version-mismatch"));
    })();
